...
if ORCHESTRATOR_TYPE == ORCHESTRATOR_TYPE_KUBERNETES or ORCHESTRATOR_TYPE == ORCHESTRATOR_TYPE_MINISHIFT:
    from app.kubernetes_client import get_pod, delete_pod, lock_pod, release_pod, update_pod_restart, exec_pod, check_error_event
else:
    from app.marathon_client import get_pod, delete_pod, lock_pod, release_pod, update_pod_restart, exec_pod, check_error_event
