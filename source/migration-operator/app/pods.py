...
@kopf.on.create('v1', 'pods', annotations={INTERFACE_ANNOTATION: INTERFACE_DIND})
@kopf.on.create('v1', 'pods', annotations={INTERFACE_ANNOTATION: INTERFACE_PIND})
...
@kopf.on.create('v1', 'pods', annotations={INTERFACE_ANNOTATION: INTERFACE_FF})
...
@kopf.on.update('v1', 'pods', field=f'metadata.annotations.{SYNC_PORT_ANNOTATION}', old=kopf.ABSENT, new=kopf.PRESENT)
